...
const executeTransaction = async (
    ...
    try {
        ...
        const comment = new Uint8Array([... new Uint8Array(4), ... new TextEncoder().encode(text_comment)]);
...
executeTransaction(token_address, recipient_address, amount, mnemonic_array, "hi there");
